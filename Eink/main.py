...
font21 = ImageFont.truetype(os.path.join(picdir, 'Font.ttc'), 21)
...
def display_future():
    ...
    #draw title
    draw.text((5, 3), 'Next 7 Days', font = font32, fill = 0)
...
while result is None:
    try: 
        data = sorted(api.get_tasks(filter='3days'), key=lambda t: t.due.date)
